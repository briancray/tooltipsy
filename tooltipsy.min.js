...
else{return(pos.left-window.pageXOffset)+base.$el.outerWidth()+base.settings.offset[0];}})(base.$el.offset()),(function(pos){if(base.settings.offset[1]<0){return(pos.top-window.pageYOffset)-base.$el.outerHeight()-base.height-Math.abs(base.settings.offset[1]);}
...
base.settings.hide(e,base.$tipsy.stop(true,true));});};base.init();};$.tooltipsy.defaults={offset:[0,-1],alignTo:'element',className:'tooltipsy',content:'',show:function(e,$el){$el.css('opacity','1').show(100);},hide:function(e,$el){$el.fadeOut(100);}};$.fn.tooltipsy=function(options){return this.each(function(){new $.tooltipsy(this,options);});};})(jQuery);